...
import kotlinx.android.synthetic.main.fragment_east.*
...
class East : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        east_IV1.setOnClickListener {
            onClick(east_IV1, 1)
        }
        east_IV2.setOnClickListener {
            onClick(east_IV2, 2)
        }
        east_IV3.setOnClickListener {
            onClick(east_IV3, 3)
        }
        east_IV4.setOnClickListener {
            onClick(east_IV4, 4)
        }
        east_IV5.setOnClickListener {
            onClick(east_IV5, 5)
        }
        east_IV6.setOnClickListener {
            onClick(east_IV6, 6)
        }
    }
    ...
    private fun updateArray() {
        ...
        for (i in 1..arrayList!!.size) {
            val id = this.resources.getIdentifier("east_IV$i", "id", activity?.packageName)
